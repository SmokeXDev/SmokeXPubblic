...
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Text = "SmokeX Client | Version: 1.0"
GuiLibrary["MainGui"].ScaledGui.ClickGui.MainWindow.TextLabel.Text = "SmokeX Client | Version: 1.0"
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Version.Text = "SmokeX Client | Version: 1.0"
GuiLibrary["MainGui"].ScaledGui.ClickGui.Version.Position = UDim2.new(1, -175 - 20, 1, -25)
createwarning("SmokeX Client", "Successfully Loaded!", 10)
...
while getgenv().Autowin do
   ...
   task.wait()
    ...
    Default = false,
    HoverText = "UPDATED Require Killaura"
})
...
game:GetService("UserInputService").JumpRequest:connect(function()
    ...
    Default = false,
    HoverText = "Disable some of anticheat"
})
...
local AnticheatDisabler = COB("Utility", {
	...
	["Default"] = false,
	["HoverText"] = "By SmokeXDev#8560 [PACHED]"
})
